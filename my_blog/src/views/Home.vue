          ...
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item>Part-time job</el-dropdown-item>
                <el-dropdown-item>Freelancer</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
        </div>
          ...
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item>Coding</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
        </div>
          ...
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item>Hokkaido</el-dropdown-item>
                <el-dropdown-item>Osaka</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
        </div>
